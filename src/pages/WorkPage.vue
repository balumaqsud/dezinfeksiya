...
const translations: Record<LangCode, Record<string, string>> = {
  uz: {
    ...
    servicesMainDesc: "DEZ.CHIK kompaniyasi Toshkent va Toshkent viloyatida muvaffaqiyatli xizmat ko'rsatadi. Bizning jamoamizda 3 yildan ortiq tajribaga ega 20 nafar professional dezinfektor ishlaydi. Har bir mijozga tibbiy mutaxassis tomonidan bepul maslahat beriladi.",
  ...
  ru: {
    ...
    servicesMainDesc: "Компания DEZ.CHIK успешно оказывает услуги в Ташкенте и Ташкентской области. В нашей команде работает 20 профессиональных дезинфекторов с опытом более 3 лет. Каждому клиенту предоставляется бесплатная консультация медицинского специалиста.",
  ...
  en: {
    ...
    servicesMainDesc: "DEZ.CHIK company successfully provides services in Tashkent and Tashkent region. Our team consists of 20 professional disinfectors with over 3 years of experience. Every client receives free consultation from a medical specialist.",
